    ...
    <section>
      ...
      <nav className="w-full bg-gray-200 flex flex-col md:flex-row justify-between p-4 gap-4">
        ...
        <div>
          ...
          >
            <option value="https://dummyjson.com/products/category/laptops">
              Laptops
            </option>
            <option value="https://dummyjson.com/products/category/smartphones">
              Smart Phones
            </option>
            <option value="https://dummyjson.com/products/category/mobile-accessories">
              Mobile Accessories
            </option>
            <option value="https://dummyjson.com/products/category/tablets">
              Tablets
            </option>
          </select>
        </div>
