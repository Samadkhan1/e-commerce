    ...
    <section>
      ...
      <nav className="w-full bg-gray-200 flex flex-col md:flex-row justify-between p-4 gap-4">
        ...
        <div>
          ...
          >
            <option value="https://dummyjson.com/products/category/mens-shirts">Shirts</option>
            <option value="https://dummyjson.com/products/category/mens-shoes">Shoes</option>
            <option value="https://dummyjson.com/products/category/mens-watches">Watches</option>
            <option value="https://dummyjson.com/products/category/sunglasses">Sun Glasses</option>
            <option value="https://dummyjson.com/products/category/sports-accessories">Sports Accessories</option>
            <option value="https://dummyjson.com/products/category/fragrances">Fragrances</option>
          </select>
        </div>
      </nav>
